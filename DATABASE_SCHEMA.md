...
| salaryBand | VARCHAR(20) | NO | 급여대역 (예: "3000-4000", 단위: 만원) |
...
### personnel 샘플
```sql
INSERT INTO personnel (id, employeeId, name, ssn, department, team, position, salaryBand, employmentType, hireDate, isActive, salaryValidity)
VALUES 
